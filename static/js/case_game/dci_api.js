...
class DCIAPI {
  ...
  async register(data) {
    ...
    if (!callsign || !displayName || !email || !password) {
  ...
  async login(credentials) {
    ...
    if (localDetectives.length === 0) {
      localDetectives.push({
        detective_id: "DCI-26-884912",
        callsign: "RAVEN-17",
        display_name: "Alex Morgan",
        email: "raven17@dci-gov.org",
  ...
  recordSolvedCase(caseId, score, endingTitle, xpEarned) {
    ...
    const record = {
      case_id: caseId,
      case_title: "Operation Blackwood: Secured Residence Homicide",
      score: score,
      status: "SOLVED",
      ending: endingTitle,
      xp_earned: xpEarned,
